...
/**
   ...
   using the API.
   <p>
   Programmers must implement the {@link net.tommalone.httpserver.HttpHandler} interface. This interface
   ...
   represented by the {@link net.tommalone.httpserver.HttpExchange} class.
   The {@link net.tommalone.httpserver.HttpServer} class is used to listen for incoming TCP connections
   ...
   <p>
   The {@link net.tommalone.httpserver.HttpExchange} class encapsulates everything an application needs to
   process incoming requests and to generate appropriate responses.
   <p>
   Registering a handler with a HttpServer creates a {@link net.tommalone.httpserver.HttpContext} object and
   {@link net.tommalone.httpserver.Filter}
   ...
   <p>
   For sensitive information, a {@link net.tommalone.httpserver.HttpsServer} can
   be used to process "https" requests secured by the SSL or TLS protocols.
   A HttpsServer must be provided with a
   {@link net.tommalone.httpserver.HttpsConfigurator} object, which contains an
