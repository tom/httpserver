...
package net.tommalone.httpserver.spi;
...
import net.tommalone.httpserver.*;
...
public abstract class HttpServerProvider {
    ...
    private static boolean loadProviderFromProperty() {
        String cn = System.getProperty("net.tommalone.httpserver.HttpServerProvider");
        if (cn == null)
            return false;
        try {
     ...
     *   <tt>net.tommalone.httpserver.HttpServerProvider</tt> is defined then it is
     ...
     *   <tt>net.tommalone.httpserver.HttpServerProvider</tt> in the resource
                ...
                .doPrivileged(new PrivilegedAction<Object>() {
                        public Object run() {
                            ...
                            if (loadProviderAsService())
                                return provider;
                            provider = new net.tommalone.httpserver.DefaultHttpServerProvider();
                            return provider;
                        }
                    });
        }
